...
class CounselingCase extends Model
{
    ...
    /**
     * Guru BK / user yang menangani kasus
     */
    ...
    {
        return self::CATEGORY_OPTIONS[$this->category]['label']
            ?? $this->category;
    }
    ...
    {
        return self::CATEGORY_OPTIONS[$this->category]['badgeClass']
            ?? self::CATEGORY_OPTIONS['LAINNYA']['badgeClass'];
    }
}