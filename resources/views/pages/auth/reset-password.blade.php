    ...
    <div class="relative z-1 min-h-screen bg-gradient-to-br from-[oklch(28%_0.13_263)] via-[oklch(42%_0.19_268)] to-[oklch(56%_0.22_258)] text-white">
        <div class="flex min-h-screen w-full flex-col">
            ...
            <div class="fixed right-4 bottom-4 z-50 sm:right-6 sm:bottom-6">
                <button
                    class="inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/15 text-white shadow-lg backdrop-blur transition-colors hover:bg-white/25 sm:h-14 sm:w-14"
