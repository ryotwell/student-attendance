...
@section('content')
    <div class="relative z-1 bg-gray-100 p-6 sm:p-0 dark:bg-gray-900">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email', 'ryotwell@gmail.com') }}" autocomplete="email" autofocus placeholder="email@example.com"
