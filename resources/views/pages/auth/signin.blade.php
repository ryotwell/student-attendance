...
@section('content')
    ...
    <div class="relative z-1 bg-[oklch(53.54%_0.2151_263.08)] dark:bg-[oklch(40%_0.2_263)] lg:bg-gray-100 lg:dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col lg:flex-row">

            <!-- ============ SISI KIRI: Branding / Portal Info ============ -->
            <div class="relative hidden w-full flex-col justify-between overflow-hidden bg-[oklch(53.54%_0.2151_263.08)] p-10 lg:flex lg:w-1/2 dark:bg-[oklch(40%_0.2_263)]">
                ...
                <div class="relative z-10 my-auto max-w-md">
                    ...
                    <div class="mt-8 space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-white/85">Akses berbeda untuk setiap peran pengguna</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/15">
                                <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                            ...
                            <p class="text-sm text-white/85">Data tersimpan aman dan terpusat</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/15">
                                <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <div class="flex w-full flex-1 flex-col justify-center px-6 py-10 lg:w-1/2 lg:px-16">
                <div class="mx-auto w-full max-w-md">
                    ...
                    <div class="rounded-2xl bg-white p-8 shadow-theme-sm dark:bg-gray-800 sm:p-10">
                        ...
                        @if (session('status'))
                            <div class="mb-5 rounded-lg border border-success-200 bg-success-50 px-4 py-3 text-sm text-success-700 dark:border-success-800 dark:bg-success-500/10 dark:text-success-400">
                                {{ session('status') }}
                            </div>
                        @endif
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="email@sekolah.sch.id"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-[oklch(53.54%_0.2151_263.08)] focus:ring-[oklch(53.54%_0.2151_263.08)]/10 dark:focus:border-[oklch(60%_0.2_263)] h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-4 pl-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('email') border-error-400 focus:border-error-400 focus:ring-error-500/10 @enderror" />
                                    </div>
                                    @error('email')
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        ...
                                        <input :type="showPassword ? 'text' : 'password'" type="password" id="password" name="password" autocomplete="current-password"
                                            placeholder="Masukkan kata sandi"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-[oklch(53.54%_0.2151_263.08)] focus:ring-[oklch(53.54%_0.2151_263.08)]/10 dark:focus:border-[oklch(60%_0.2_263)] h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('password') border-error-400 focus:border-error-400 focus:ring-error-500/10 @enderror" />
                                        @error('password')
                                            <p class="mt-1.5 text-sm text-error-500">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="text-center text-sm text-gray-500 dark:text-gray-400">
                                    Belum punya akun?
                                    <a href="{{ route('register') }}" class="text-[oklch(53.54%_0.2151_263.08)] hover:text-[oklch(48%_0.2151_263.08)] font-medium dark:text-[oklch(60%_0.2_263)]">
                                        Daftar di sini
                                    </a>
                                </div>
                            </div>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    class="bg-[oklch(53.54%_0.2151_263.08)] hover:bg-[oklch(48%_0.2151_263.08)] inline-flex size-14 items-center justify-center rounded-full text-white shadow-lg transition-colors"
