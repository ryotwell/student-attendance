    ...
    <div class="mx-auto max-w-6xl">
        {{-- <x-common.component-card title="Absensi {{ $class->name }} - {{ $schedule->subject->name }}"> --}}
            ...
            <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Kelas {{ $class->name }}</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Mata Pelajaran {{ $schedule->subject->name }}</p>
                </div>
                    ...
                    @forelse ($class->students as $index => $student)
                        ...
                        <div class="group student-card rounded-2xl border border-gray-200 bg-white p-5 transition-all duration-200 hover:-translate-y-1 hover:shadow-xl dark:border-gray-700 dark:bg-gray-900"
                            ...
                            <div class="mb-5 flex items-center gap-4">
                                <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-900/30 dark:text-brand-400">
