...
@section('content')
    ...
    <x-common.component-card title="Daftar Kelas">
        <div class="flex flex-col gap-4">
            ...
            <!-- Form Filter -->
            <form method="GET" action="{{ route('classes.index') }}" class="flex flex-wrap items-end gap-4">
                <!-- Search -->
                <div class="flex-1 min-w-[200px]">
                    <label for="search" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Cari Kelas</label>
                ...
                <!-- Filter Tahun Ajaran -->
                <div class="w-48">
                    <label for="academic_year_id" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Tahun Ajaran</label>
                ...
                <!-- Filter Wali Kelas -->
                <div class="w-48">
                    <label for="user_id" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Wali Kelas</label>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-10 text-center sm:px-6">
                                <p class="text-sm text-gray-500 dark:text-gray-400">Tidak ada kelas yang ditemukan.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
